...
namespace Lock {
    ...
    esp_err_t Lock::open() {
        ...
        uint8_t payload[] = {
            ...
            0x03, 0x55, 0xAA, 0x00, 0x00, 0x00, 0x01, 0x55, 0xAA,
            0x03, 0x00, 0x04, 0x04, 0x00, 0x0F, 0x31, 0x00, 0x00,
            0x0B, 0x01, 0xAA, 0xAA, 0x38, 0x38, 0x38, 0x38, 0x38, 
            0x38, 0x38, 0x38, 0xFB
        };

        espCheck = sendData(payload);
        return espCheck;
    }
}