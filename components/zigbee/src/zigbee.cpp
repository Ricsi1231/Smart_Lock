...
namespace ZigbeeComponent
{
    ...
    void Zigbee::rtosTask(void *pvParameter) {
        auto *zigbeeInstance = static_cast<Zigbee*>(pvParameter);
        ...
        esp_zb_core_action_handler_register(zigbeeInstance->action_handler);
    ...
    ZigbeeConfig::ZigbeeConfig(Zigbee& zigbeeInstance) {
        this->instance = &zigbeeInstance;
    }

    esp_err_t ZigbeeConfig::registerActionHandler() {
